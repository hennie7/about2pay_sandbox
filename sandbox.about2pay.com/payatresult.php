...
<div style="width:100%;">
	   <img id="image" src=""  style="height:50px;display: block;margin-left: auto;margin-right: auto;"></img>
</div>
<br/>
 <img id="sf" style="height:200px" src="images/payment_pending.png"></img>
...
<script>
	...
	back2shopurl="<?php echo $_SESSION["m_back2shop_url"] ?>";
