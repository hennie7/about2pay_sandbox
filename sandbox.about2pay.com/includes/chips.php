  <div style="text-align:center">
	<img src="images/chips-logo.png" alt="" style="height:70px" class="chipsLogo" style="background-color:#f8f8f8;">
  </div>
          <br/>
          <div id="step1" trg="step1">
            ...
            <ons-card id="loginFormHolder">
			 <div style="text-align:center">
				<p style="color:black"><b>Please enter your CHIPS&copy; details to log into your account</b></p>
				  </br>
                  <div id="chipsqr"></div>
                  <h1 id="chipscode"></h1>
                  <br/>
              ...
              <form id="loginForm">
                  <ons-list>
                      <ons-list-item>
                          <input type="text" class="text-input" name="username" id="username" placeholder="Mobile Number" value="<?php echo $_POST['mobile'] ?>" style="width: 90%;">
                      </ons-list-item>
                  </ons-list>
                  <ons-list>
			  ...
			  <div id="popup1" class="overlay">
				<div class="popup">
					...
					<div class="content" style="color:black">
						Please use your CHIPS Money Manager App on your smartphone to update your password.
					</div>
				</div>
			</div>
              <ons-row class="appLogosHolder">
                <p>Register a CHIPS® account by downloading the mobile app</p>
                <a href="https://tosto.re/chipsewallet">
            ...
            <ons-card id="loggedInFormHolder" style="text-align: left;" >
              ...
              <table>
                <tr>
                  <td valign="top" style="width:50%;padding-right: 20px;text-align:right">
                    ...
                    function handleTransaction(e){
                      switch(e){
                        case "approve":
							...
							if (txLog.amount>curBal){
							  alert("Amount Requested Exceeds Available Balance");
							  return;
							} else {
								$.ajax({
									url: 'php/getClientPaymentMethods.php',
